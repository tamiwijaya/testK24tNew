function tableToGrid(a, b) {
    jQuery(a).each(function () {
        if (!this.grid) {
            ...
            var a = jQuery(this).width(), c = jQuery("tr td:first-child input[type=checkbox]:first", jQuery(this)), d = jQuery("tr td:first-child input[type=radio]:first", jQuery(this)), c = 0 < c.length, d = !c && 0 < d.length, e = c || d, f = [], g = [];
...
!function (b) {
    b.jgrid = b.jgrid || {}, b.extend(b.jgrid, {
        "version": "4.5.3", "htmlDecode": function (a) {
            ...
            var f, g, h = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, i = "string" == typeof c ? c.match(h) : null, h = function (a, b) {
                for (a = "" + a, b = parseInt(b, 10) || 2; a.length < b;)a = "0" + a;
                return a
            }, j = {"m": 1, "d": 1, "y": 1970, "h": 0, "i": 0, "s": 0, "u": 0}, k = 0, k = function (a, b) {
                return 0 === a ? 12 === b && (b = 0) : 12 !== b && (b += 12), b
            };
            if (void 0 === e && (e = b.jgrid.formatter.date), void 0 === e.parseRe && (e.parseRe = /[Tt\\\/:_;.,\t\s-]/), e.masks.hasOwnProperty(a) && (a = e.masks[a]), c && null != c)if (isNaN(c - 0) || "u" !== ("" + a).toLowerCase())if (c.constructor === Date)k = c; else if (null !== i)k = new Date(parseInt(i[1], 10)), i[3] && (a = 60 * Number(i[5]) + Number(i[6]), a *= "-" === i[4] ? 1 : -1, a -= k.getTimezoneOffset(), k.setTime(Number(Number(k) + 6e4 * a))); else {
            ...
            } else k = new Date(1e3 * parseFloat(c)); else k = new Date(j.y, j.m, j.d, j.h, j.i, j.s, j.u);
            ...
            var l = k.getMilliseconds(), m = k.getDay(), n = k.getFullYear(), o = (m + 6) % 7 + 1, p = (new Date(n, i - 1, j) - new Date(n, 0, 1)) / 864e5, q = {
                "d": h(j),
                "D": e.dayNames[m],
                "j": j,
                "l": e.dayNames[m + 7],
            ...
            var a = b("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"), c = a.appendTo("body").find("td").width();
            ...
            return new function (d, c) {
                ...
                return 0 < d.length && (E = "object" != typeof d[0] ? !1 : !0), this._hasData = function () {
                    ...
                    var c = u[b].by, d = u[b].dir, f = u[b].type, g = u[b].datefmt;
                    if (b === u.length - 1)return e._getOrder(a, c, d, f, g);
                    b++;
                    for (var h, c = e._getGroup(a, c, d, f, g), d = [], f = 0; f < c.length; f++)for (h = e._doSort(c[f].items, b), g = 0; g < h.length; g++)d.push(h[g]);
                    return d
                }, this._getOrder = function (a, c, d, f, g) {
                    var h, k, l = [], m = [], n = "a" === d ? 1 : -1;
                    ...
                    var i = d, k = void 0 === g.stype ? "text" : g.stype;
                    if (null !== d)switch (k) {
                        case"int":
                        case"integer":
                    ...
                    var d = null == c ? a : c, d = f ? b.trim(d.toString()).length : d.toString().length;
        ...
        return this.each(function () {
            if (!this.grid) {
                var c = b.extend(!0, {
                    ...
                    "dragMove": function (a) {
                        if (this.resizing) {
                            var b, d = a.clientX - this.resizing.startX, a = this.headers[this.resizing.idx], e = "ltr" === c.direction ? a.width + d : a.width - d;
                            e > 33 && (this.curGbox.css({"left": this.resizing.sOL + d}), !0 === c.forceFit ? (b = this.headers[this.resizing.idx + c.nv], d = "ltr" === c.direction ? b.width - d : b.width + d, d > 33 && (a.newWidth = e, b.newWidth = d)) : (this.newWidth = "ltr" === c.direction ? c.tblwidth + d : c.tblwidth - d, a.newWidth = e))
                        }
                    },
                    "dragEnd": function () {
                        if (this.hDiv.style.cursor = "default", this.resizing) {
                            var a = this.resizing.idx, e = this.headers[a].newWidth || this.headers[a].width, e = parseInt(e, 10);
                    ...
                    "populateVisible": function () {
                        ...
                        if (a) {
                            ...
                            if (f) {
                                ...
                                var j = Math.round(g.position().top) - d, k = j + g.height();
                                f *= i;
                                var l, m, n;
                    ...
                    "selectionPreserver": function (a) {
                        var c = a.p, d = c.selrow, e = c.selarrrow ? b.makeArray(c.selarrrow) : null, f = a.grid.bDiv.scrollLeft, g = function () {
                            var h;
                            if (c.selrow = null, c.selarrrow = [], c.multiselect && e && 0 < e.length)for (h = 0; h < e.length; h++)e[h] !== d && b(a).jqGrid("setSelection", e[h], !1, null);
                ...
                if ("TABLE" !== this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        var h = b("<div class='ui-jqgrid-view'></div>"), i = b.jgrid.msie;
                        ...
                        var k = function (a, b) {
                            ...
                            var j = d.p.colModel[a], k = j.align, l = 'style="', m = j.classes, n = j.name, o = [];
                            ...
                            var d;
                            this.p.deepempty ? b(this.rows).slice(1).remove() : (d = this.rows.length > 0 ? this.rows[0] : null, b(this.firstChild).empty().append(d)), a && this.p.scroll && (b(this.grid.bDiv.firstChild).css({"height": "auto"}), b(this.grid.bDiv.firstChild.firstChild).css({
                                "height": 0,
                                "display": "none"
                            ...
                            var i, j = "-1", k = "", c = c ? "display:none;" : "", e = "ui-widget-content jqgrow ui-row-" + d.p.direction + (e ? " " + e : "") + (h ? " ui-state-highlight" : ""), h = b(d).triggerHandler("jqGridRowAttr", [f, g, a]);
                            ...
                            var h = new Date, i = "local" !== d.p.datatype && d.p.loadonce || "xmlstring" === d.p.datatype, j = d.p.xmlReader, l = "local" === d.p.datatype ? "local" : "xml";
                            if (i && (d.p.data = [], d.p._index = {}, d.p.localReader.id = "_id_"), d.p.reccount = 0, b.isXMLDoc(a)) {
                                ...
                                var m, n, u, w, x, y, z, A, B, C = b(d), D = 0, E = d.p.multiselect === !0 ? 1 : 0, F = 0, G = d.p.rownumbers === !0 ? 1 : 0, H = [], I = {}, J = [], K = d.p.altRows === !0 ? d.p.altclass : "";
                                ...
                                var L = a.length, M = 0, N = [], O = parseInt(d.p.rowNum, 10), P = d.p.scroll ? b.jgrid.randId() : 1;
                                if (L > 0 && d.p.page <= 0 && (d.p.page = 1), a && L) {
                                    g && (O *= g + 1);
                                    var Q, g = b.isFunction(d.p.afterInsertRow), R = !1;
                                    for (d.p.grouping && (R = d.p.groupingView.groupCollapse === !0, Q = b.jgrid.getMethod("groupingPrepare")); L > M;) {
                                        ...
                                        } else for (m = 0; m < H.length; m++)u = b.jgrid.getXmlData(z, H[m]), I[d.p.colModel[m + E + F + G].name] = u, J.push(o(A, u, m + E + F + G, M + e, z, I));
                                ...
                                if (d.p.treeGrid || d.p.scroll || (d.grid.bDiv.scrollTop = 0), d.p.reccount = D, d.p.treeANode = -1, d.p.userDataOnFooter && C.jqGrid("footerData", "set", d.p.userData, !0), i && (d.p.records = L, d.p.lastpage = Math.ceil(L / O)), f || d.updatepager(!1, !0), i)for (; L > D;) {
                                    ...
                                    } else for (m = 0; m < H.length; m++)u = b.jgrid.getXmlData(z, H[m]), I[d.p.colModel[m + E + F + G].name] = u;
                            ...
                            if (a) {
                                ...
                                var l, m, n, u, w = b(d), x = 0, y = [], z = d.p.multiselect ? 1 : 0, A = d.p.subGrid === !0 ? 1 : 0, B = d.p.rownumbers === !0 ? 1 : 0, C = s(z + A + B);
                                i = r(i);
                                var D, E, F, G, H, I, J = {}, K = [], L = d.p.altRows === !0 ? d.p.altclass : "";
                                ...
                                var M, N = parseInt(d.p.rowNum, 10), O = d.p.scroll ? b.jgrid.randId() : 1, P = !1;
                                g && (N *= g + 1), "local" === d.p.datatype && !d.p.deselectAfterSort && (P = !0);
                                var Q, R = b.isFunction(d.p.afterInsertRow), S = [], T = !1;
                                ...
                                if (d.p.treeGrid || d.p.scroll || (d.grid.bDiv.scrollTop = 0), d.p.reccount = x, d.p.treeANode = -1, d.p.userDataOnFooter && w.jqGrid("footerData", "set", d.p.userData, !0), j && (d.p.records = a, d.p.lastpage = Math.ceil(a / N)), f || d.updatepager(!1, !0), j)for (; a > x && E[x];) {
                            ...
                            var c, e, f, g = d.p.multiSort ? [] : "", h = [], i = !1, j = {}, k = [], l = [];
                            if (b.isArray(d.p.data)) {
                                ...
                                if (b.each(d.p.colModel, function () {
                                    ...
                                    if (d.p.ignoreCase && (q = q.ignoreCase()), d.p.search === !0) {
                                        ...
                                        if (r)"string" == typeof r && (r = b.jgrid.parse(r)), a(r); else try {
                                            q = p[d.p.postData.searchOper](q)(d.p.postData.searchField, d.p.postData.searchString, j[d.p.postData.searchField])
                                        } catch (s) {
                                        }
                                    }
                                    if (d.p.grouping)for (n = 0; m > n; n++)q.orderBy(l[n], o.groupOrder[n], k[n].stype, k[n].srcfmt);
                                    ...
                                    var r = q.select(), t = parseInt(d.p.rowNum, 10), u = r.length, v = parseInt(d.p.page, 10), w = Math.ceil(u / t), x = {}, r = r.slice((v - 1) * t, v * t), j = q = null;
                            ...
                            if (!d.grid.hDiv.loading) {
                                var c, e = d.p.scroll && a === !1, f = {}, g = d.p.prmNames;
                                ...
                                var h = b.isFunction(d.p.loadComplete), i = h ? d.p.loadComplete : null, j = 0, a = a || 1;
                                ...
                                var o = d.p.scroll ? d.rows.length - 1 : 1, f = b(d).triggerHandler("jqGridBeforeRequest");
                                if (f !== !1 && "stop" !== f)if (b.isFunction(d.p.datatype))d.p.datatype.call(d, d.p.postData, "load_" + d.p.id, o, a, j); else {
                            ...
                            var e, f, h, i, j = "", l = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", m = "", n = function (a) {
                                var c;
                            ...
                            "rtl" === g && (l += m), d.p.pginput === !0 && (j = "<td dir='" + g + "'>" + b.jgrid.format(d.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + b.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === !0 ? (f = ["first" + c, "prev" + c, "next" + c, "last" + c], "rtl" === g && f.reverse(), l += "<td id='" + f[0] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-first'></span></td>", l += "<td id='" + f[1] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-prev'></span></td>", l = l + ("" !== j ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" + j + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" : "") + ("<td id='" + f[2] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-next'></span></td>"), l += "<td id='" + f[3] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-end'></span></td>") : "" !== j && (l += j), "ltr" === g && (l += m), l += "</tr></tbody></table>", d.p.viewrecords === !0 && b("td#" + a + "_" + d.p.recordpos, "#" + e).append("<div dir='" + g + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"), b("td#" + a + "_" + d.p.pagerpos, "#" + e).append(l), m = b(".ui-jqgrid").css("font-size") || "11px", b(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + m + ";visibility:hidden;' ></div>"), l = b(l).clone().appendTo("#testpg").width(), b("#testpg").remove(), l > 0 && ("" !== j && (l += 50), b("td#" + a + "_" + d.p.pagerpos, "#" + e).width(l)), d.p._nvtd = [], d.p._nvtd[0] = l ? Math.floor((d.p.width - l) / 2) : Math.floor(d.p.width / 3), d.p._nvtd[1] = 0, l = null, b(".ui-pg-selbox", "#" + e).bind("change", function () {
                                ...
                                var a = k(d.p.page, 1), b = k(d.p.lastpage, 1), e = !1, f = !0, g = !0, h = !0, i = !0;
                            ...
                            if (d.p.colModel[c].sortable && !(d.p.savedRow.length > 0)) {
                                if (e || (d.p.lastsort === c ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[c].firstsortorder || "asc", d.p.page = 1), d.p.multiSort)E(c, g); else {
                                    if (f) {
                            ...
                            var c, e = d.grid.headers, f = b.jgrid.getCellIndex(a);
                            for (c = 0; c < e.length; c++)if (a === e[c].el) {
                                f = c;
                                break
                            }
                            return f
                        ...
                        var K, L, M, N, O, P, Q, R, S = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", T = R = "", U = [], V = [];
                        if (L = [], !0 === d.p.shrinkToFit && !0 === d.p.forceFit)for (f = d.p.colModel.length - 1; f >= 0; f--)if (!d.p.colModel[f].hidden) {
                            d.p.colModel[f].resizable = !1;
                            break
                        }
                        if ("horizontal" === d.p.viewsortcols[1] && (R = " ui-i-asc", T = " ui-i-desc"), K = i ? "class='ui-th-div-ie'" : "", R = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + R + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + g + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + T + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + g + "'></span></span>"), d.p.multiSort)for (U = d.p.sortname.split(","), f = 0; f < U.length; f++)L = b.trim(U[f]).split(" "), U[f] = b.trim(L[0]), V[f] = L[1] ? b.trim(L[1]) : d.p.sortorder || "asc";
                        ...
                        !0 === d.p.autowidth && (S = b(j).innerWidth(), d.p.width = S > 0 ? S : "nw"), function () {
                            var a, c, f, g, h = 0, i = b.jgrid.cell_width ? 0 : k(d.p.cellLayout, 0), j = 0, l = k(d.p.scrollOffset, 0), m = !1, n = 0;
                        ...
                        var h = b("tr:first", S), Z = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                        if (d.p.disableClick = !1, b("th", h).each(function (a) {
                                ...
                                if (1 === b(a.target).closest("th>span.ui-jqgrid-resize").length) {
                                    ...
                                    if (d.p.forceFit === !0) {
                                        var f, g = d.p, h = c;
                                        for (f = c + 1; f < d.p.colModel.length; f++)if (d.p.colModel[f].hidden !== !0) {
                                            h = f;
                                            break
                                        }
                                        g.nv = h - c
                        ...
                        var Z = null, h = b("<table class='ui-jqgrid-htable' style='width:" + d.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(S), _ = d.p.caption && !0 === d.p.hiddengrid ? !0 : !1;
                        f = b("<div class='ui-jqgrid-hbox" + ("rtl" === g ? "-rtl" : "") + "'></div>"), S = null, e.hDiv = document.createElement("div"), b(e.hDiv).css({"width": e.width + "px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(f), b(f).append(h), h = null, _ && b(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + b(d.p.pager).attr("id"), b(d.p.pager).css({"width": e.width + "px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(j), _ && b(d.p.pager).hide(), D(d.p.pager, "")), !1 === d.p.cellEdit && !0 === d.p.hoverrows && b(d).bind("mouseover", function (a) {
                        ...
                        b(d).before(e.hDiv).click(function (a) {
                            ...
                            var c = b(P).hasClass("cbox"), e = b(d).triggerHandler("jqGridBeforeSelectRow", [Q[0].id, a]);
                            if ((e = e === !1 || "stop" === e ? !1 : !0) && b.isFunction(d.p.beforeSelectRow) && (e = d.p.beforeSelectRow.call(d, Q[0].id, a)), "A" !== P.tagName && ("INPUT" !== P.tagName && "TEXTAREA" !== P.tagName && "OPTION" !== P.tagName && "SELECT" !== P.tagName || c) && e === !0)if (aa = Q[0].id, ba = b.jgrid.getCellIndex(P), ca = b(P).closest("td,th").html(), b(d).triggerHandler("jqGridCellSelect", [aa, ba, ca, a]), b.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, aa, ba, ca, a), d.p.cellEdit === !0)if (d.p.multiselect && c)b(d).jqGrid("setSelection", aa, !0, a); else {
                                aa = Q[0].rowIndex;
                                try {
                                    b(d).jqGrid("editCell", aa, ba, !0)
                                } catch (f) {
                                }
                            } else if (d.p.multikey)a[d.p.multikey] ? b(d).jqGrid("setSelection", aa, !0, a) : d.p.multiselect && c && (c = b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + aa).is(":checked"), b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + aa)[d.p.useProp ? "prop" : "attr"]("checked", c)); else {
                            ...
                            "width": e.width + "px"
                        }).scroll(e.scrollGrid), b("table:first", e.bDiv).css({"width": d.p.tblwidth + "px"}), b.support.tbody || 2 === b("tbody", this).length && b("tbody:gt(0)", this).remove(), d.p.multikey && (b.jgrid.msie ? b(e.bDiv).bind("selectstart", function () {
                            return !1
                        ...
                        if (b(e.cDiv).append(da).append("<span class='ui-jqgrid-title" + ("rtl" === g ? "-rtl" : "") + "'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix"), b(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0] && (e.uDiv = document.createElement("div"), "top" === d.p.toolbar[1] ? b(e.uDiv).insertBefore(e.hDiv) : "bottom" === d.p.toolbar[1] && b(e.uDiv).insertAfter(e.hDiv), "both" === d.p.toolbar[1] ? (e.ubDiv = document.createElement("div"), b(e.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(e.hDiv), b(e.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id).insertAfter(e.hDiv), _ && b(e.ubDiv).hide()) : b(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), _ && b(e.uDiv).hide()), d.p.toppager && (d.p.toppager = b.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = b("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, b(e.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width).insertBefore(e.hDiv), D(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], f = b("<div class='ui-jqgrid-hbox" + ("rtl" === g ? "-rtl" : "") + "'></div>"), b(e.sDiv).append(f).width(e.width).insertAfter(e.hDiv), b(f).append(Y), e.footers = b(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = "ui-state-default jqgrid-rownum"), _ && b(e.sDiv).hide()), f = null, d.p.caption) {
                            ...
                            !0 === d.p.hidegrid && (b(".ui-jqgrid-titlebar-close", e.cDiv).click(function (a) {
                                var c, f = b.isFunction(d.p.onHeaderClick), g = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", h = this;
                        ...
                        b(e.hDiv).after(e.bDiv).mousemove(function (a) {
                            ...
                            var e, f, g, h, i, j, l, m = "", n = d.p.pager ? "_" + b.jgrid.jqID(d.p.pager.substr(1)) : "", o = d.p.toppager ? "_" + d.p.toppager.substr(1) : "";
                            g = parseInt(d.p.page, 10) - 1, 0 > g && (g = 0), g *= parseInt(d.p.rowNum, 10), i = g + d.p.reccount, d.p.scroll && (e = b("tbody:first > tr:gt(0)", d.grid.bDiv), g = i - e.length, d.p.reccount = e.length, (e = e.outerHeight() || d.grid.prevRowHeight) && (f = g * e, l = parseInt(d.p.records, 10) * e, b(">div:first", d.grid.bDiv).css({"height": l}).children("div:first").css({
                                "height": f,
                                "display": f ? "" : "none"
        ...
        "getGridParam": function (a) {
            ...
            var a, c = [], d = 0, e = 0;
            return this.each(function () {
                if ((a = this.rows.length) && a > 0)for (; a > d;)b(this.rows[d]).hasClass("jqgrow") && (c[e] = this.rows[d].id, e++), d++
            }), c
            ...
            return this.each(function () {
                var h, i, j = this;
                if (void 0 === a)f = !0, c = [], d = j.rows.length; else {
                    if (i = b(j).jqGrid("getGridRowById", a), !i)return e;
                    d = 2
                }
                for (; d > g;)f && (i = j.rows[g]), b(i).hasClass("jqgrow") && (b('td[role="gridcell"]', i).each(function (a) {
                    if (h = j.p.colModel[a].name, "cb" !== h && "subgrid" !== h && "rn" !== h)if (!0 === j.p.treeGrid && h === j.p.ExpandColumn)e[h] = b.jgrid.htmlDecode(b("span:first", this).html()); else try {
                        e[h] = b.unformat.call(j, this, {"rowId": i.id, "colModel": j.p.colModel[a]}, a)
                    } catch (c) {
            ...
            return this.each(function () {
                ...
                var h, i, j = this, k = typeof d, l = {};
                if (i = b(this).jqGrid("getGridRowById", a), !i)return !1;
                if (c)try {
                    if (b(this.p.colModel).each(function (d) {
                            e = this.name;
                            var g = b.jgrid.getAccessor(c, e);
                            void 0 !== g && (l[e] = this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? b.unformat.date.call(j, g, this) : g, h = j.formatter(a, g, d, c, "edit"), f = this.title ? {"title": b.jgrid.stripHtml(h)} : {}, !0 === j.p.treeGrid && e === j.p.ExpandColumn ? b("td[role='gridcell']:eq(" + d + ") > span:first", i).html(h).attr(f) : b("td[role='gridcell']:eq(" + d + ")", i).html(h).attr(f))
                        }), "local" === j.p.datatype) {
                        var m, n = b.jgrid.stripPref(j.p.idPrefix, a), o = j.p._index[n];
                        if (j.p.treeGrid)for (m in j.p.treeReader)j.p.treeReader.hasOwnProperty(m) && delete l[j.p.treeReader[m]];
            ...
            d || (d = "last");
            var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t = !1, u = "";
            return c && (b.isArray(c) ? (n = !0, d = "last", o = a) : (c = [c], n = !1), this.each(function () {
                ...
                for (var w = 0, x = "", y = {}, z = b.isFunction(this.p.afterInsertRow) ? !0 : !1; v > w;) {
                    ...
                    if (g.unshift(this.constructTr(a, !1, x, y, q, !1)), g[g.length] = "</tr>", 0 === this.rows.length)b("table:first", this.grid.bDiv).append(g.join("")); else switch (d) {
                        case"last":
            ...
            return void 0 === a && (a = "get"), "boolean" != typeof d && (d = !0), a = a.toLowerCase(), this.each(function () {
                ...
                return !k.grid || !k.p.footerrow || "set" === a && e(c) ? !1 : (h = !0, void b(this.p.colModel).each(function (e) {
                    f = this.name, "set" === a ? void 0 !== c[f] && (j = d ? k.formatter("", c[f], e, c, "edit") : c[f], g = this.title ? {"title": b.jgrid.stripHtml(j)} : {}, b("tr.footrow td:eq(" + e + ")", k.grid.sDiv).html(j).attr(g), h = !0) : "get" === a && (i[f] = b("tr.footrow td:eq(" + e + ")", k.grid.sDiv).html())
                }))
            }), "get" === a ? i : h
        }, "showHideCol": function (a, c) {
            return this.each(function () {
                var d, e = this, f = !1, g = b.jgrid.cell_width ? 0 : e.p.cellLayout;
                if (e.grid) {
                    "string" == typeof a && (a = [a]), c = "none" !== c ? "" : "none";
                    var h = "" === c ? !0 : !1, i = e.p.groupHeader && ("object" == typeof e.p.groupHeader || b.isFunction(e.p.groupHeader));
            ...
            function f(c, d) {
                b(">tr" + (d || ""), c).each(function () {
                    var c = this, d = b.makeArray(c.cells);
                    b.each(a, function () {
                        var a = d[this];
                        a && c.appendChild(a)
                    })
            ...
            return this.each(function () {
                if (this.grid) {
                    var d, e, f, g, h = this, i = 0, j = b.jgrid.cell_width ? 0 : h.p.cellLayout, k = 0, l = !1, m = h.p.scrollOffset, n = 0;
                    if ("boolean" != typeof c && (c = h.p.shrinkToFit), !isNaN(a)) {
                        if (a = parseInt(a, 10), h.grid.width = h.p.width = a, b("#gbox_" + b.jgrid.jqID(h.p.id)).css("width", a + "px"), b("#gview_" + b.jgrid.jqID(h.p.id)).css("width", a + "px"), b(h.grid.bDiv).css("width", a + "px"), b(h.grid.hDiv).css("width", a + "px"), h.p.pager && b(h.p.pager).css("width", a + "px"), h.p.toppager && b(h.p.toppager).css("width", a + "px"), !0 === h.p.toolbar[0] && (b(h.grid.uDiv).css("width", a + "px"), "both" === h.p.toolbar[1] && b(h.grid.ubDiv).css("width", a + "px")), h.p.footerrow && b(h.grid.sDiv).css("width", a + "px"), !1 === c && !0 === h.p.forceFit && (h.p.forceFit = !1), !0 === c) {
                            ...
                            var i = 0, o = 0 < h.grid.cols.length;
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    c.css({"height": a + (isNaN(a) ? "" : "px")}), !0 === this.p.frozenColumns && b("#" + b.jgrid.jqID(this.p.id) + "_frozen").parent().height(c.height() - 16), this.p.height = a, this.p.scroll && this.grid.populateVisible()
                }
            })
            ...
            var e, f, g, h, i = [], j = 0, c = "boolean" != typeof c ? !1 : c;
            return void 0 === d && (d = !1), this.each(function () {
                ...
                if (this.grid && (isNaN(a) ? b(this.p.colModel).each(function (b) {
                    ...
                    var l = this.rows.length, m = 0, n = 0;
                    if (l && l > 0) {
                        for (; l > m;) {
            ...
            return this.each(function () {
                if (this.grid) {
                    if ("boolean" != typeof a && (a = !1), this.p.deepempty)b("#" + b.jgrid.jqID(this.p.id) + " tbody:first tr:gt(0)").remove(); else {
            ...
            return this.each(function () {
                ...
                b("body").is("[role]") || b("body").attr("role", "application"), a.p.scrollrows = c.scrollingRows, b(a).keydown(function (d) {
                    var e, f, g, h = b(a).find("tr[tabindex=0]")[0], i = a.p.treeReader.expanded_field;
                    if (h)if (g = a.p._index[b.jgrid.stripPref(a.p.idPrefix, h.id)], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                        if (38 === d.keyCode) {
                            if (f = h.previousSibling, e = "", f)if (b(f).is(":hidden")) {
                                for (; f;)if (f = f.previousSibling, !b(f).is(":hidden") && b(f).hasClass("jqgrow")) {
                                    e = f.id;
                                    break
                                }
                            } else e = f.id;
                        ...
                        if (40 === d.keyCode) {
                            if (f = h.nextSibling, e = "", f)if (b(f).is(":hidden")) {
                                for (; f;)if (f = f.nextSibling, !b(f).is(":hidden") && b(f).hasClass("jqgrow")) {
                                    e = f.id;
                                    break
                                }
                            } else e = f.id;
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
        ...
        var g = c, d = a.extend({}, a.jgrid.formatter, d);
        try {
        ...
        "NumberFormat": function (b, c) {
            if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
                var d, e = 0 > b, f = "" + b, g = c.decimalSeparator || ".";
                if (a.fmatter.isNumber(c.decimalPlaces)) {
                    var h = c.decimalPlaces, f = Math.pow(10, h), f = "" + Math.round(b * f) / f;
                    if (d = f.lastIndexOf("."), h > 0)for (0 > d ? (f += g, d = f.length - 1) : "." !== g && (f = f.replace(".", g)); f.length - 1 - d < h;)f += "0"
                }
                if (c.thousandsSeparator) {
                    h = c.thousandsSeparator, d = f.lastIndexOf(g), d = d > -1 ? d : f.length;
                    var i, g = f.substring(d), j = -1;
        ...
        if (void 0 !== c.colModel.formatoptions ? (f = c.colModel.formatoptions.value, d = void 0 === c.colModel.formatoptions.separator ? ":" : c.colModel.formatoptions.separator, e = void 0 === c.colModel.formatoptions.delimiter ? ";" : c.colModel.formatoptions.delimiter) : void 0 !== c.colModel.editoptions && (f = c.colModel.editoptions.value, d = void 0 === c.colModel.editoptions.separator ? ":" : c.colModel.editoptions.separator, e = void 0 === c.colModel.editoptions.delimiter ? ";" : c.colModel.editoptions.delimiter), f) {
            var h = !0 === c.colModel.editoptions.multiple ? !0 : !1, i = [];
            if (h && (i = b.split(","), i = a.map(i, function (b) {
                    return a.trim(b)
                })), a.fmatter.isString(f)) {
                var j, k = f.split(e), l = 0;
                for (j = 0; j < k.length; j++)if (e = k[j].split(d), 2 < e.length && (e[1] = a.map(e, function (a, b) {
                        return b > 0 ? a : void 0
                    }).join(d)), h)-1 < a.inArray(e[0], i) && (g[l] = e[1], l++); else if (a.trim(e[0]) === a.trim(b)) {
                    g[0] = e[1];
                    break
                }
        ...
        var c = a(this).closest("tr.jqgrow"), d = c.attr("id"), e = a(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"), e = a("#" + e), f = e[0], g = f.p, h = g.colModel[a.jgrid.getCellIndex(this)], i = h.frozen ? a("tr#" + d + " td:eq(" + a.jgrid.getCellIndex(this) + ") > div", e) : a(this).parent(), j = {
            "keys": !1,
            "onEdit": null,
            "onSuccess": null,
            "afterSave": null,
        ...
        var d = {"keys": !1, "editbutton": !0, "delbutton": !0, "editformbutton": !1}, e = c.rowId, f = "";
        ...
        var f, g = c.colModel.formatter, h = c.colModel.formatoptions || {}, i = /([\.\*\_\'\(\)\{\}\+\?\\])/g, j = c.colModel.unformat || a.fn.fmatter[g] && a.fn.fmatter[g].unformat;
        if (void 0 !== j && a.isFunction(j))f = j.call(this, a(b).text(), c, b); else if (void 0 !== g && a.fmatter.isString(g))switch (f = a.jgrid.formatter || {}, g) {
            case"integer":
        ...
        var e = a.extend({}, void 0 !== c.colModel.formatoptions ? c.colModel.formatoptions : c.colModel.editoptions), c = void 0 === e.separator ? ":" : e.separator, f = void 0 === e.delimiter ? ";" : e.delimiter;
        if (e.value) {
            var g = e.value, e = !0 === e.multiple ? !0 : !1, h = [];
            if (e && (h = b.split(","), h = a.map(h, function (b) {
                    return a.trim(b)
                })), a.fmatter.isString(g)) {
                var i, j = g.split(f), k = 0;
                for (i = 0; i < j.length; i++)if (f = j[i].split(c), 2 < f.length && (f[1] = a.map(f, function (a, b) {
                        return b > 0 ? a : void 0
                    }).join(c)), e)-1 < a.inArray(f[1], h) && (d[k] = f[0], k++); else if (a.trim(f[1]) === a.trim(b)) {
                    d[0] = f[0];
                    break
                }
    ...
    a.jgrid.extend({
        "getColProp": function (a) {
            ...
            for (d = 0; d < c.length; d++)if (c[d].name === a) {
                b = c[d];
                break
            }
            return b
            ...
            return this.each(function () {
                ...
                if (this.grid) {
                    for (a || (a = this.p.sortname),
                             d = 0; d < this.p.colModel.length; d++)if (this.p.colModel[d].index === a || this.p.colModel[d].name === a) {
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    a(d).attr({"id": b}), d.className = c, b = a.jgrid.jqID(this.id), a(d).removeClass("ui-jqgrid-btable"), 1 === a(this.p.pager).parents("#gbox_" + b).length ? (a(d).insertBefore("#gbox_" + b).show(), a(this.p.pager).insertBefore("#gbox_" + b)) : a(d).insertBefore("#gbox_" + b).show(), a(this).jqGrid("clearBeforeUnload"), a("#gbox_" + b).remove()
                }
            })
            ...
            return b = a.extend({
                ...
                if (!this.ftoolbar) {
                    var d, e = function () {
                        ...
                        a("#sopt_menu").remove();
                        var h, i, f = parseInt(f, 10), g = parseInt(g, 10) + 18, f = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:' + (a(".ui-jqgrid-view").css("font-size") || "11px") + ";left:" + f + "px;top:" + g + 'px;">', g = a(d).attr("soper"), j = [], k = 0, l = a(d).attr("colname");
                    ...
                    a.each(c.p.colModel, function (f) {
                        var h, i, j = this;
                        i = "";
                        var k, l = "=", m = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + c.p.direction + "'></th>"), n = a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"), o = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear'></td></tr></table>");
                        if (!0 === this.hidden && a(m).css("display", "none"), this.search = !1 === this.search ? !1 : !0, void 0 === this.stype && (this.stype = "text"), h = a.extend({}, this.searchoptions || {}), this.search) {
                            if (b.searchOperators) {
                                for (i = h.sopt ? h.sopt[0] : "select" === j.stype ? "eq" : b.defaultSearch, k = 0; k < b.odata.length; k++)if (b.odata[k].oper === i) {
                                    l = b.operands[i] || "";
                                    break
                                }
                                    ...
                                    if (i = this.surl || h.dataUrl)a(n).append(o), a.ajax(a.extend({
                                        ...
                                        "success": function (d) {
                                            void 0 !== h.buildSelect ? (d = h.buildSelect(d)) && a("td:eq(1)", o).append(d) : a("td:eq(1)", o).append(d), void 0 !== h.defaultValue && a("select", n).val(h.defaultValue), a("select", n).attr({
                                                "name": j.index || j.name,
                                                "id": "gs_" + j.name
                                            }), h.attr && a("select", n).attr(h.attr), a("select", n).css({"width": "100%"}), a.jgrid.bindEv.call(c, a("select", n)[0], h), b.autosearch === !0 && a("select", n).change(function () {
                                                return e(), !1
                                            }), d = null
                                        }
                                        ...
                                        if (j.searchoptions ? (p = void 0 === j.searchoptions.value ? "" : j.searchoptions.value, q = void 0 === j.searchoptions.separator ? ":" : j.searchoptions.separator, r = void 0 === j.searchoptions.delimiter ? ";" : j.searchoptions.delimiter) : j.editoptions && (p = void 0 === j.editoptions.value ? "" : j.editoptions.value, q = void 0 === j.editoptions.separator ? ":" : j.editoptions.separator, r = void 0 === j.editoptions.delimiter ? ";" : j.editoptions.delimiter), p) {
                                            ...
                                            var s;
                                            if ("string" == typeof p)for (i = p.split(r), s = 0; s < i.length; s++)p = i[s].split(q), r = document.createElement("option"), r.value = p[0], r.innerHTML = p[1], f.appendChild(r); else if ("object" == typeof p)for (s in p)p.hasOwnProperty(s) && (r = document.createElement("option"), r.value = s, r.innerHTML = p[s], f.appendChild(r));
                        ...
                        var d = a(this).parents("tr:first"), f = parseInt(a("td.ui-search-oper", d).attr("colindex"), 10), g = a.extend({}, c.p.colModel[f].searchoptions || {}), g = g.defaultValue ? g.defaultValue : "";
                        ...
                        var e, f = {}, g = 0, d = "boolean" != typeof d ? !0 : d;
                        a.each(c.p.colModel, function () {
            ...
            return void 0 === b && (b = !0), this.each(function () {
                var c, d, e, f, g, h;
                d = this.grid;
                var i = a("table.ui-jqgrid-htable thead", d.hDiv), j = this.p.colModel;
                if (d) {
                    for (a(this).unbind(".setGroupHeaders"), c = a("<tr>", {"role": "rowheader"}).addClass("ui-jqgrid-labels"), f = d.headers, d = 0, e = f.length; e > d; d++) {
                    ...
                    a(i).children("tr.ui-jqgrid-labels").remove(), a(i).prepend(c), !0 === b && a(this).jqGrid("setGridParam", {"groupHeader": null})
                }
            })
        }, "setGroupHeaders": function (b) {
            return b = a.extend({"useColSpanStyle": !1, "groupHeaders": []}, b || {}), this.each(function () {
                this.p.groupHeader = b;
                var c, d, e, f, g, h, i, j = 0, k = this.p.colModel, l = k.length, m = this.grid.headers, n = a("table.ui-jqgrid-htable", this.grid.hDiv), o = n.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
                e = n.children("thead");
                ...
                for (a(this).prepend(e), e = a("<tr>", {"role": "rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; l > c; c++)if (g = m[c].el, h = a(g), d = k[c], f = {
                        "height": "0px",
                        "width": m[c].width + "px",
                        "display": d.hidden ? "none" : ""
                    }, a("<th>", {"role": "gridcell"}).css(f).addClass("ui-first-th-" + this.p.direction).appendTo(p), g.style.width = "", f = r(d.name, b.groupHeaders), f >= 0) {
                    for (f = b.groupHeaders[f], j = f.numberOfColumns, i = f.titleText, f = d = 0; j > f && l > c + f; f++)k[c + f].hidden || d++;
                    f = a("<th>").attr({"role": "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                        "height": "22px",
                        "border-top": "0px none"
                    }).html(i), d > 0 && f.attr("colspan", "" + d), this.p.headertitles && f.attr("title", f.text()), 0 === d && f.hide(), h.before(f), e.append(g), j -= 1
                } else 0 === j ? b.useColSpanStyle ? h.attr("rowspan", "2") : (a("<th>", {"role": "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                    "display": d.hidden ? "none" : "",
                    "border-top": "0px none"
    ...
    a.extend(a.jgrid, {
        "showModal": function (a) {
            ...
            if (a.fn.jqm && !0 === c.jqm)a(b).attr("aria-hidden", "true").jqmHide(); else {
                if ("" !== c.gb)try {
            ...
            var i, d = a.extend(!0, {}, a.jgrid.jqModal || {}, d), j = document.createElement("div"), k = this, h = a.extend({}, h || {});
            ...
            if (a(n).addClass("ui-jqdialog-content ui-widget-content").attr("id", b.modalcontent), a(n).append(c), j.appendChild(n), a(j).prepend(l), !0 === g ? a("body").append(j) : "string" == typeof g ? a(g).append(j) : a(j).insertBefore(e), a(j).css(h), void 0 === d.jqModal && (d.jqModal = !0), c = {}, a.fn.jqm && !0 === d.jqModal ? (0 === d.left && 0 === d.top && d.overlay && (h = [], h = a.jgrid.findPos(f), d.left = h[0] + 4, d.top = h[1] + 4), c.top = d.top + "px", c.left = d.left) : (0 !== d.left || 0 !== d.top) && (c.left = d.left, c.top = d.top + "px"), a("a.ui-jqdialog-titlebar-close", l).click(function () {
                    ...
                    "aria-hidden": "true"
                }), void 0 === d.drag && (d.drag = !0), void 0 === d.resize && (d.resize = !0), d.drag)if (a(l).css("cursor", "move"), a.fn.jqDrag)a(j).jqDrag(l); else try {
            ...
            !0 === d.closeOnEscape && a(j).keydown(function (c) {
            ...
            if (c = a.extend({
                    ...
                    "jqm": !0,
                    "jqM": !0
                }, c || {}), a.fn.jqm && !0 === c.jqm)c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else {
            ...
            if (a.fn.jqm && !g && (g = !1), b = "", 0 < f.buttons.length)for (e = 0; e < f.buttons.length; e++)void 0 === f.buttons[e].id && (f.buttons[e].id = "info_button_" + e), b += "<a id='" + f.buttons[e].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[e].text + "</a>";
            ...
            switch (b) {
                ...
                case"select":
                    if (h = document.createElement("select"), h.setAttribute("role", "select"), e = [], !0 === c.multiple ? (b = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : b = !1, void 0 !== c.dataUrl) {
                        var b = c.name ? ("" + c.id).substring(0, ("" + c.id).length - ("" + c.name).length - 1) : "" + c.id, j = c.postData || f.postData;
                        i.p && i.p.idPrefix && (b = a.jgrid.stripPref(i.p.idPrefix, b)), a.ajax(a.extend({
                            ...
                            "success": function (b) {
                                var c = [], d = this.elem, e = this.vl, f = a.extend({}, this.options), h = f.multiple === !0, b = a.isFunction(f.buildSelect) ? f.buildSelect.call(i, b) : b;
                ...
                case"password":
                case"button":
                    k = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, g(h, c), "button" !== b && (e ? c.size || a(h).css({"width": "98%"}) : c.size || (c.size = 20)), a(h).attr("role", k);
                    break;
                case"image":
                case"file":
                ...
                case"custom":
                    ...
                    try {
                        ...
                        n = a(n).addClass("customelement").attr({"id": c.id, "name": c.name}), a(h).empty().append(n)
                    } catch (o) {
            ...
            var f, g, h;
            if (h = this.p.colModel, void 0 === d)if ("string" == typeof c) {
                for (d = 0, e = h.length; e > d; d++)if (h[d].name === c) {
                    f = h[d].editrules, c = d, null != h[d].formoptions && (g = h[d].formoptions.label);
                    break
                }
            } else c >= 0 && (f = h[c].editrules); else f = d, g = void 0 === e ? "_" : e;
            if (f) {
        ...
        "searchGrid": function (b) {
            return b = a.extend(!0, {
                ...
                if (d.grid) {
                    ...
                    if ("string" == typeof i && (i = a.jgrid.parse(i)), !0 === b.recreateFilter && a("#" + a.jgrid.jqID(h.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(h.themodal))[0])c(a("#fbox_" + a.jgrid.jqID(+d.p.id))); else {
                        ...
                        var m, n = a.extend([], d.p.colModel), o = "<a id='" + e + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>", p = "<a id='" + e + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>", q = "", r = "", s = !1, t = -1;
                        if (b.showQuery && (q = "<a id='" + e + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>"), b.columns.length ? (n = b.columns, t = 0, m = n[0].index || n[0].name) : a.each(n, function (a, b) {
                                if (b.label || (b.label = d.p.colNames[a]), !s) {
                                    var c = void 0 === b.search ? !0 : b.search, e = b.hidden === !0;
                        ...
                        s = !1, b.tmplNames && b.tmplNames.length && (s = !0, r = b.tmplLabel, r += "<select class='ui-template'>", r += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                        ...
                        }), !0 === b.multipleGroup && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + e)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + e)), b.gbox = "#gbox_" + e, b.layer ? a.jgrid.createModal(h, j, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {"position": "relative"}) : a.jgrid.createModal(h, j, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]), (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(h.themodal)).keydown(function (c) {
                            var d = a(c.target);
                            ...
                            var c, f = a("#" + e), i = {}, j = f.jqFilter("filterData");
                            ...
                            return d.p.search = !0, a.extend(d.p.postData, i), g = a(d).triggerHandler("jqGridFilterSearch"), void 0 === g && (g = !0), g && a.isFunction(b.onSearch) && (g = b.onSearch.call(d, d.p.filters)), g !== !1 && a(d).trigger("reloadGrid", [{"page": 1}]), b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(h.themodal), {
                            ...
                            var c = {}, f = a("#" + e);
                            return d.p.search = !1, b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", f[0].resetFilter(), s && a(".ui-template", j).val("default"), a.extend(d.p.postData, c), g = a(d).triggerHandler("jqGridFilterReset"), void 0 === g && (g = !0), g && a.isFunction(b.onReset) && (g = b.onReset.call(d)), g !== !1 && a(d).trigger("reloadGrid", [{"page": 1}]), b.closeAfterReset && a.jgrid.hideModal("#" + a.jgrid.jqID(h.themodal), {
                                "gb": "#gbox_" + a.jgrid.jqID(d.p.id),
                                "jqm": b.jqModal,
                                "onClose": b.onClose
                            }), !1
            ...
            return d = a.extend(!0, {
                ...
                function f(c, d, e, f) {
                    ...
                    return "_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (m) {
                        if (g = this.name, k = (h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'" : "", "cb" !== g && "subgrid" !== g && !0 === this.editable && "rn" !== g) {
                            if (!1 === q)j = ""; else if (g === d.p.ExpandColumn && !0 === d.p.treeGrid)j = a("td[role='gridcell']:eq(" + m + ")", d.rows[q]).text(); else {
                                try {
                    ...
                    if ("_empty" === c)a(m).each(function () {
                        ...
                        n && (a('td[role="gridcell"]', n).each(function (h) {
                            if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && !0 === m[h].editable) {
                                if (f === d.p.ExpandColumn && !0 === d.p.treeGrid)g = a(this).text(); else try {
                ...
                function i() {
                    ...
                    for (i in p)if (p.hasOwnProperty(i) && (l = a.jgrid.checkValues.call(o, p[i], i), !1 === l[0]))break;
                    if (h(), l[0] && (m = a(o).triggerHandler("jqGridAddEditClickSubmit", [b[o.p.id], p, r]), void 0 === m && a.isFunction(b[o.p.id].onclickSubmit) && (m = b[o.p.id].onclickSubmit.call(o, b[o.p.id], p, r) || {}), l = a(o).triggerHandler("jqGridAddEditBeforeSubmit", [p, a("#" + t), r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].beforeSubmit) && (l = b[o.p.id].beforeSubmit.call(o, p, a("#" + t), r))), l[0] && !b[o.p.id].processing) {
                        if (b[o.p.id].processing = !0, a("#sData", v + "_2").addClass("ui-state-active"), f = n.oper, e = n.id, p[f] = "_empty" === a.trim(p[o.p.id + "_id"]) ? n.addoper : n.editoper, p[f] !== n.addoper ? p[e] = p[o.p.id + "_id"] : void 0 === p[e] && (p[e] = p[o.p.id + "_id"]), delete p[o.p.id + "_id"], p = a.extend(p, b[o.p.id].editData, m), !0 === o.p.treeGrid)for (k in p[f] === n.addoper && (j = a(o).jqGrid("getGridParam", "selrow"), p["adjacency" === o.p.treeGridModel ? o.p.treeReader.parent_id_field : "parent_id"] = j), o.p.treeReader)o.p.treeReader.hasOwnProperty(k) && (m = o.p.treeReader[k], p.hasOwnProperty(m) && !(p[f] === n.addoper && "parent_id_field" === k) && delete p[m]);
                ...
                function l() {
                    var b;
                    if ("_empty" !== c && void 0 !== o.p.savedRow && 0 < o.p.savedRow.length && a.isFunction(a.fn.jqGrid.restoreRow))for (b = 0; b < o.p.savedRow.length; b++)if (o.p.savedRow[b].id == c) {
                ...
                function n() {
                    var b = a(o).jqGrid("getDataIDs"), c = a("#id_g", v).val();
                ...
                if (o.grid && c) {
                    var p, q, r, s = o.p.id, t = "FrmGrid_" + s, u = "TblGrid_" + s, v = "#" + a.jgrid.jqID(u), w = {
                        ...
                        "scrollelm": t
                    }, x = a.isFunction(b[o.p.id].beforeShowForm) ? b[o.p.id].beforeShowForm : !1, y = a.isFunction(b[o.p.id].afterShowForm) ? b[o.p.id].afterShowForm : !1, z = a.isFunction(b[o.p.id].beforeInitData) ? b[o.p.id].beforeInitData : !1, A = a.isFunction(b[o.p.id].onInitializeForm) ? b[o.p.id].onInitializeForm : !1, B = !0, C = 1, D = 0, t = a.jgrid.jqID(t);
                    ...
                    if (d.checkOnUpdate && d.jqModal && !d.modal && (E = !1), void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0]) {
                        ...
                        var F = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px", B = isNaN(d.datawidth) ? d.datawidth : d.datawidth + "px", F = a("<form name='FormPost' id='" + t + "' class='FormGrid' onSubmit='return false;' style='width:" + B + ";overflow:auto;position:relative;height:" + F + ";'></form>").data("disabled", !1), G = a("<table id='" + u + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), B = a(o).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + t), r]);
                        ...
                        !0 === d.closeOnEscape && (d.closeOnEscape = !1, L = !0), u = a("<div></div>").append(F).append(u), a.jgrid.createModal(w, u, d, "#gview_" + a.jgrid.jqID(o.p.id), a("#gbox_" + a.jgrid.jqID(o.p.id))[0]), z && (a("#pData, #nData", v + "_2").css("float", "right"), a(".EditButton", v + "_2").css("text-align", "left")), b[o.p.id].topinfo && a(".tinfo", v).show(), b[o.p.id].bottominfo && a(".binfo", v + "_2").show(), u = u = null, a("#" + a.jgrid.jqID(w.themodal)).keydown(function (c) {
                            ...
                            return k() ? (a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {
                                "gb": "#gbox_" + a.jgrid.jqID(s), "jqm": d.jqModal, "onClose": b[o.p.id].onClose
                            }), !1) : !1
            ...
            return d = a.extend(!0, {
                ...
                function f(b, c, e, f) {
                    var g, h, i, j, k, l, m, n, o, p = 0, q = [], r = !1, s = "<td class='CaptionTD form-view-label ui-widget-content' width='" + d.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", t = "", u = ["integer", "number", "currency"], v = 0, w = 0;
                ...
                function i() {
                    var b = a(j).jqGrid("getDataIDs"), c = a("#id_g", "#" + m).val();
                    return [a.inArray(c, b), b]
                }
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function () {
                        ...
                        if (i = "<span></span>", this.p.groupButton && (i = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"), i.bind("click", function () {
                            ...
                            i.bind("click", function () {
                                for (void 0 === b.rules && (b.rules = []), d = 0; d < f.p.columns.length; d++) {
                                    var c = void 0 === f.p.columns[d].search ? !0 : f.p.columns[d].search, e = f.p.columns[d].hidden === !0;
                        ...
                        if (null !== c && (i = a("<input type='button' value='-' title='Delete group' class='delete-group'/>"), h.append(i), i.bind("click", function () {
                            ...
                            })), void 0 !== b.groups)for (d = 0; d < b.groups.length; d++)h = a("<tr></tr>"), g.append(h), i = a("<td class='first'></td>"), h.append(i), i = a("<td colspan='4'></td>"), i.append(this.createTableForGroup(b.groups[d], b)), h.append(i);
                        ...
                        function a(c) {
                            var d, e = "(";
                            if (void 0 !== c.groups)for (d = 0; d < c.groups.length; d++)1 < e.length && (e = "OR" === c.groupOp ? e + " || " : e + " && "), e += a(c.groups[d]);
                            if (void 0 !== c.rules)for (d = 0; d < c.rules.length; d++) {
                                1 < e.length && (e = "OR" === c.groupOp ? e + " || " : e + " && ");
                                var f = c.rules[d];
                                if (b.p.errorcheck) {
                                    for (var g = void 0, i = void 0, g = 0; g < b.p.columns.length; g++)if (b.p.columns[g].name === f.field) {
                                        i = b.p.columns[g];
                                        break
                                    }
                                    i && h(f.data, i)
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
        "editRow": function (b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, {
                ...
                var c, d, e, f, g, h = this, i = 0, j = null, l = {};
                h.grid && (e = a(h).jqGrid("getInd", b, !0), !1 !== e && (g = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(h, k, b) : void 0, void 0 === g && (g = !0), g && "0" === (a(e).attr("editable") || "0") && !a(e).hasClass("not-editable-row"))) && (f = h.p.colModel, a('td[role="gridcell"]', e).each(function (e) {
                    ...
                    if (g)d = a("span:first", this).html(); else try {
                        d = a.unformat.call(h, this, {"rowId": b, "colModel": f[e]}, e)
                    } catch (k) {
                    ...
                    if ("cb" !== c && "subgrid" !== c && "rn" !== c && (h.p.autoencode && (d = a.jgrid.htmlDecode(d)), l[c] = d, !0 === f[e].editable)) {
                        ...
                        var m = a.extend({}, f[e].editoptions || {}, {"id": b + "_" + c, "name": c});
            ...
            var k, l, m, n, j = a.extend(!0, {
                ...
                "restoreAfterError": !0,
                "mtype": "POST"
            }, a.jgrid.inlineEdit, j), o = !1, p = this[0], q = {}, r = {}, s = {};
            if (!p.grid)return o;
            ...
            if (i = a.isFunction(j.beforeSaveRow) ? j.beforeSaveRow.call(p, j, b) : void 0, void 0 === i && (i = !0), i) {
                if (i = a(n).attr("editable"), j.url = j.url || p.p.editurl, "1" === i) {
                    ...
                    if (a('td[role="gridcell"]', n).each(function (b) {
                        ...
                        try {
                            var u = a(p).jqGrid("getGridRowById", b), v = a.jgrid.findPos(u);
                    ...
                    if (i = p.p.prmNames, u = b, v = !1 === p.p.keyIndex ? i.id : p.p.colModel[p.p.keyIndex + (!0 === p.p.rownumbers ? 1 : 0) + (!0 === p.p.multiselect ? 1 : 0) + (!0 === p.p.subGrid ? 1 : 0)].name, q && (q[i.oper] = i.editoper, void 0 === q[v] || "" === q[v] ? q[v] = b : n.id !== p.p.idPrefix + q[v] && (i = a.jgrid.stripPref(p.p.idPrefix, b), void 0 !== p.p._index[i] && (p.p._index[q[v]] = p.p._index[i], delete p.p._index[i]), b = p.p.idPrefix + q[v], a(n).attr("id", b), p.p.selrow === u && (p.p.selrow = b), a.isArray(p.p.selarrrow) && (i = a.inArray(u, p.p.selarrrow), i >= 0 && (p.p.selarrrow[i] = b)), p.p.multiselect) && (i = "jqg_" + p.p.id + "_" + b, a("input.cbox", n).attr("id", i).attr("name", i)), void 0 === p.p.inlineData && (p.p.inlineData = {}), q = a.extend({}, q, p.p.inlineData, j.extraparam)), "clientArray" === j.url) {
                        ...
                        }), i = a(p).jqGrid("setRowData", b, q), a(n).attr("editable", "0"), v = 0; v < p.p.savedRow.length; v++)if ("" + p.p.savedRow[v].id == "" + u) {
                            l = v;
                            break
                        }
                            ...
                            if (a("#lui_" + a.jgrid.jqID(p.p.id)).hide(), "success" === d) {
                                ...
                                if (e = a(p).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, q]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(p, c)), a.isArray(e) ? (f = e[0], q = e[1] || q) : f = e, !0 === f) {
                                    for (p.p.autoencode && a.each(q, function (b, c) {
                                        q[b] = a.jgrid.htmlDecode(c)
                                    }), q = a.extend({}, q, r), a(p).jqGrid("setRowData", b, q), a(n).attr("editable", "0"), f = 0; f < p.p.savedRow.length; f++)if ("" + p.p.savedRow[f].id == "" + b) {
                                        l = f;
                                        break
                                    }
                        ...
                        "error": function (c, d, e) {
                            if (a("#lui_" + a.jgrid.jqID(p.p.id)).hide(), a(p).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, e, j]), a.isFunction(j.errorfunc))j.errorfunc.call(p, b, c, d, e); else {
            ...
            return "object" === a.type(d[0]) ? e = d[0] : a.isFunction(c) && (e.afterrestorefunc = c), e = a.extend(!0, {}, a.jgrid.inlineEdit, e), this.each(function () {
                ...
                if (g.grid && (d = a(g).jqGrid("getInd", b, !0), d !== !1 && (f = a.isFunction(e.beforeCancelRow) ? e.beforeCancelRow.call(g, cancelPrm, sr) : void 0, void 0 === f && (f = !0), f))) {
                    for (f = 0; f < g.p.savedRow.length; f++)if ("" + g.p.savedRow[f].id == "" + b) {
                        c = f;
                        break
                    }
                    if (c >= 0) {
                ...
                if (this.grid) {
                    ...
                    void 0 === d && (d = !0), d && (b.rowID = a.isFunction(b.rowID) ? b.rowID.call(c, b) : null != b.rowID ? b.rowID : a.jgrid.randId(), !0 === b.useDefValues && a(c.p.colModel).each(function () {
                        if (this.editoptions && this.editoptions.defaultValue) {
                            var d = this.editoptions.defaultValue, d = a.isFunction(d) ? d.call(c) : d;
        ...
        "editCell": function (b, c, d) {
                ...
                if (e.grid && !0 === e.p.cellEdit) {
                    if (d = 1 <= e.p.savedRow.length ? 0 : null, null !== d) {
                        ...
                        if (g !== e.p.savedRow[d].v) {
                            ...
                            if (!0 === o[0]) {
                                if (d = a(e).triggerHandler("jqGridBeforeSubmitCell", [e.rows[b].id, j, f, b, c]) || {}, a.isFunction(e.p.beforeSubmitCell) && ((d = e.p.beforeSubmitCell.call(e, e.rows[b].id, j, f, b, c)) || (d = {})), 0 < a("input.hasDatepicker", h).length && a("input.hasDatepicker", h).datepicker("hide"), "remote" === e.p.cellsubmit)if (e.p.cellurl) {
                                    var p = {};
            ...
            return this.each(function () {
                ...
                if (this.grid && !0 === this.p.cellEdit) {
                    for (d = c + 1; d < this.p.colModel.length; d++)if (!0 === this.p.colModel[d].editable) {
                        e = d;
                        break
                    }
            ...
            return this.each(function () {
                var d, e = !1;
                if (this.grid && !0 === this.p.cellEdit) {
                    for (d = c - 1; d >= 0; d--)if (!0 === this.p.colModel[d].editable) {
                        e = d;
                        break
                    }
                    !1 !== e ? a(this).jqGrid("editCell", b, e, !0) : 0 < this.p.savedRow.length && a(this).jqGrid("saveCell", b, c)
    ...
    a.fn.jqm = function (d) {
        ...
        "hash": {}, "open": function (b, h) {
            var i = c[b], j = i.c, k = "." + j.closeClass, l = parseInt(i.w.css("z-index")), l = l > 0 ? l : 3e3, m = a("<div></div>").css({
                "height": "100%",
                "width": "100%",
                "position": "fixed",
                "left": 0,
    ...
    var b = 0, c = a.jqm.hash, d = [], e = !1, f = function (b) {
        try {
        ...
        var e = c[d[d.length - 1]], g = !a(b.target).parents(".jqmID" + e.s)[0];
        ...
        "setSubGrid": function () {
            return this.each(function () {
                ...
                if (this.p.subGridOptions = a.extend({
                        ...
                        "search": !1,
                        "fixed": !0
                    }), b = this.p.subGridModel, b[0])for (b[0].align = a.extend([], b[0].align || []), c = 0; c < b[0].name.length; c++)b[0].align[c] = b[0].align[c] || "left"
            })
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    var e, f, g, h, i, j = function (b, c, e) {
                        ...
                        var e, f, g, h, i, k = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), l = a("<tr></tr>");
                        ...
                        if (a(k).append(l), b && (h = d.p.jsonReader.subgrid, e = a.jgrid.getAccessor(b, h.root), void 0 !== e))for (f = 0; f < e.length; f++) {
                            if (g = e[f], l = a("<tr class='ui-widget-content ui-subtblcell'></tr>"), !0 === h.repeatitems)for (h.cell && (g = g[h.cell]), i = 0; i < g.length; i++)j(l, g[i] || "&#160;", i); else {
                                var m = d.p.subGridModel[0].mapping || d.p.subGridModel[0].name;
                                if (m.length)for (i = 0; i < m.length; i++)j(l, g[m[i]] || "&#160;", i)
                            }
                            a(k).append(l)
                        }
    ...
    a.extend(a.jgrid, {
        ...
        "groupingSetup": function () {
            return this.each(function () {
                var b, c, d = this.p.colModel, e = this.p.groupingView;
                if (null === e || "object" != typeof e && !a.isFunction(e))this.p.grouping = !1; else if (e.groupField.length) {
            ...
            return this.each(function () {
                var f, g, h, i, j = this.p.groupingView, k = this, l = j.groupField.length, m = 0;
            ...
            return this.each(function () {
                var c = this.p.groupingView, d = b.split("_"), e = parseInt(d[d.length - 2], 10);
                d.splice(d.length - 2, 2);
                var f, g = d.join("_"), d = c.minusicon, h = c.plusicon, i = a("#" + a.jgrid.jqID(b)), i = i.length ? i[0].nextSibling : null, j = a("#" + a.jgrid.jqID(b) + " span.tree-wrap-" + this.p.direction), k = function (b) {
                ...
                if (j.hasClass(d)) {
                    if (c.showSummaryOnHide) {
                        if (i)for (; i && !(a(i).hasClass("jqfoot") && parseInt(a(i).attr("jqfootlevel"), 10) <= e);)a(i).hide(), i = i.nextSibling
                    } else if (i)for (; i && (c = k(i.className), !(void 0 !== c && e >= c));)a(i).hide(), i = i.nextSibling;
            ...
            return this.each(function () {
                function d(a, b, c) {
                    ...
                    if (0 === b)d = c[a]; else {
                        var e = c[a].idx;
                        if (0 === e)d = c[a]; else for (; a >= 0; a--)if (c[a].idx === e - b) {
                            d = c[a];
                            break
                        }
                    }
                ...
                var e, f, g, h = this, i = h.p.groupingView, j = "", k = "", l = i.groupCollapse ? i.plusicon : i.minusicon, m = [], n = i.groupField.length, l = l + (" tree-wrap-" + h.p.direction);
                a.each(h.p.colModel, function (a, b) {
                    var c;
                    for (c = 0; n > c; c++)if (i.groupField[c] === b.name) {
                        m[c] = a;
                        break
                    }
                });
                var o = 0, p = a.makeArray(i.groupSummary);
                p.reverse(), a.each(i.groups, function (q, r) {
                    ...
                    if (j += '<tr id="' + e + '"' + (i.groupCollapse && 0 < r.idx ? ' style="display:none;" ' : " ") + 'role="row" class= "ui-widget-content jqgroup ui-row-' + h.p.direction + " " + f + '"><td style="padding-left:' + 12 * r.idx + 'px;" colspan="' + c + '">' + k + a.jgrid.template(i.groupText[r.idx], g, r.cnt, r.summary) + "</td></tr>", n - 1 === r.idx) {
                        var t, u, v = i.groups[q + 1], w = void 0 !== v ? i.groups[q + 1].startRow : b.length;
                        ...
                        for (v = 0; o > v; v++)if (p[v]) {
                            ...
                            var y, z = h.p.colModel, A = u.cnt;
                            for (t = 0; c > t; t++) {
                                var B = "<td " + h.formatCol(t, 1, "") + ">&#160;</td>", C = "{0}";
        ...
        "setTreeNode": function (b, c) {
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid)for (var e, f, g, h, i = d.p.expColInd, j = d.p.treeReader.expanded_field, k = d.p.treeReader.leaf_field, l = d.p.treeReader.level_field, m = d.p.treeReader.icon_field, n = d.p.treeReader.loaded; c > b;)h = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id), h = d.p.data[d.p._index[h]], "nested" === d.p.treeGridModel && !h[k] && (e = parseInt(h[d.p.treeReader.left_field], 10), f = parseInt(h[d.p.treeReader.right_field], 10), h[k] = f === e + 1 ? "true" : "false", d.rows[b].cells[d.p._treeleafpos].innerHTML = h[k]), e = parseInt(h[l], 10), 0 === d.p.tree_root_level ? (g = e + 1, f = e) : (g = e, f = e - 1), g = "<div class='tree-wrap tree-wrap-" + d.p.direction + "' style='width:" + 18 * g + "px;'>", g += "<div style='" + ("rtl" === d.p.direction ? "right:" : "left:") + 18 * f + "px;' class='ui-icon ", void 0 !== h[n] && (h[n] = "true" === h[n] || !0 === h[n] ? !0 : !1), "true" === h[k] || !0 === h[k] ? (g += (void 0 !== h[m] && "" !== h[m] ? h[m] : d.p.treeIcons.leaf) + " tree-leaf treeclick", h[k] = !0, f = "leaf") : (h[k] = !1, f = ""), h[j] = ("true" === h[j] || !0 === h[j] ? !0 : !1) && (h[n] || void 0 === h[n]), g = !1 === h[j] ? g + (!0 === h[k] ? "'" : d.p.treeIcons.plus + " tree-plus treeclick'") : g + (!0 === h[k] ? "'" : d.p.treeIcons.minus + " tree-minus treeclick'"), g += "></div></div>", a(d.rows[b].cells[i]).wrapInner("<span class='cell-wrapper" + f + "'></span>").prepend(g), e !== parseInt(d.p.tree_root_level, 10) && ((h = (h = a(d).jqGrid("getNodeParent", h)) && h.hasOwnProperty(j) ? h[j] : !0) || a(d.rows[b]).css("display", "none")), a(d.rows[b].cells[i]).find("div.treeclick").bind("click", function (b) {
                    ...
                    var b = a.jgrid.stripPref(d.p.idPrefix, a(b.target || b.srcElement, d.rows).closest("tr.jqgrow")[0].id), c = d.p._index[b];
            ...
            return this.each(function () {
                var b, c, d, e = this, f = 0, g = !1, h = [];
                if (e.p.treeGrid) {
                    e.p.treedatatype || a.extend(e.p, {"treedatatype": e.p.datatype}), e.p.subGrid = !1, e.p.altRows = !1, e.p.pgbuttons = !1, e.p.pginput = !1, e.p.gridview = !0, null === e.p.rowTotal && (e.p.rowNum = 1e4), e.p.multiselect = !1, e.p.rowList = [], e.p.expColInd = 0, e.p.treeIcons = a.extend({
                    ...
                    for (c in e.p.colModel)if (e.p.colModel.hasOwnProperty(c))for (d in b = e.p.colModel[c].name, b === e.p.ExpandColumn && !g && (g = !0, e.p.expColInd = f), f++, e.p.treeReader)e.p.treeReader.hasOwnProperty(d) && e.p.treeReader[d] === b && h.push(b);
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var d = a(this).jqGrid("getNodeAncestors", b), e = this.p.treeReader.expanded_field;
                    a(d).each(function () {
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var d = this.p.treeReader.leaf_field, e = this.p.treeReader.loaded;
            ...
            return this.each(function () {
                var c, d, e, f, g = this.p.localReader.id, h = this.p.treeReader.left_field, i = this.p.treeReader.right_field;
                if (this.grid && this.p.treeGrid && (c = this.p._index[b], void 0 !== c)) {
                    ...
                    if (0 < j.length)for (c = 0; c < j.length; c++)a(this).jqGrid("delRowData", j[c][g]);
                    if ("nested" === this.p.treeGridModel) {
                        if (g = a.jgrid.from(this.p.data).greater(h, d, {"stype": "integer"}).select(), g.length)for (f in g)g.hasOwnProperty(f) && (g[f][h] = parseInt(g[f][h], 10) - e);
                        if (g = a.jgrid.from(this.p.data).greater(i, d, {"stype": "integer"}).select(), g.length)for (f in g)g.hasOwnProperty(f) && (g[f][i] = parseInt(g[f][i], 10) - e)
                    }
                }
            })
            ...
            var f = this[0];
            if (d) {
                var g, h, i, j, k, l = f.p.treeReader.expanded_field, m = f.p.treeReader.leaf_field, n = f.p.treeReader.level_field, o = f.p.treeReader.parent_id_field, p = f.p.treeReader.left_field, q = f.p.treeReader.right_field, r = f.p.treeReader.loaded;
                g = 0;
                var s, t = c;
                if (void 0 === e && (e = !1), void 0 === b || null === b) {
                    if (k = f.p.data.length - 1, k >= 0)for (; k >= 0;)g = Math.max(g, parseInt(f.p.data[k][f.p.localReader.id], 10)), k--;
                    b = g + 1
                }
                ...
                if (s = !1, void 0 === c || null === c || "" === c ? (t = c = null, g = "last", j = f.p.tree_root_level, k = f.p.data.length + 1) : (g = "after", h = f.p._index[c], i = f.p.data[h], c = i[f.p.localReader.id], j = parseInt(i[n], 10) + 1, k = a(f).jqGrid("getFullTreeNode", i), k.length ? (t = k = k[k.length - 1][f.p.localReader.id], k = a(f).jqGrid("getInd", t) + 1) : k = a(f).jqGrid("getInd", c) + 1, i[m] && (s = !0, i[l] = !0, a(f.rows[u]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(f.p.treeIcons.leaf + " tree-leaf").addClass(f.p.treeIcons.minus + " tree-minus"), f.p.data[h][m] = !1, i[r] = !0)), h = k + 1, void 0 === d[l] && (d[l] = !1), void 0 === d[r] && (d[r] = !1), d[n] = j, void 0 === d[m] && (d[m] = !0), "adjacency" === f.p.treeGridModel && (d[o] = c), "nested" === f.p.treeGridModel) {
                    var v;
                    if (null !== c) {
                        if (m = parseInt(i[q], 10), n = a.jgrid.from(f.p.data), n = n.greaterOrEquals(q, m, {"stype": "integer"}), n = n.select(), n.length)for (v in n)n.hasOwnProperty(v) && (n[v][p] = n[v][p] > m ? parseInt(n[v][p], 10) + 2 : n[v][p], n[v][q] = n[v][q] >= m ? parseInt(n[v][q], 10) + 2 : n[v][q]);
                        d[p] = m, d[q] = m + 1
                    } else {
                        if (m = parseInt(a(f).jqGrid("getCol", q, !1, "max"), 10), n = a.jgrid.from(f.p.data).greater(p, m, {"stype": "integer"}).select(), n.length)for (v in n)n.hasOwnProperty(v) && (n[v][p] = parseInt(n[v][p], 10) + 2);
                        if (n = a.jgrid.from(f.p.data).greater(q, m, {"stype": "integer"}).select(), n.length)for (v in n)n.hasOwnProperty(v) && (n[v][q] = parseInt(n[v][q], 10) + 2);
                        d[p] = m + 1, d[q] = m + 2
                    }
                }
        ...
        "jqGridImport": function (b) {
            return b = a.extend({
                ...
                var c = this, d = function (b, d) {
                    var e, f, g = a(d.xmlGrid.config, b)[0], h = a(d.xmlGrid.data, b)[0];
                    if (xmlJsonClass.xml2json && a.jgrid.parse) {
                        g = xmlJsonClass.xml2json(g, " "), g = a.jgrid.parse(g);
                        for (f in g)g.hasOwnProperty(f) && (e = g[f]);
                        h ? (h = g.grid.datatype, g.grid.datatype = "xmlstring", g.grid.datastr = b, a(c).jqGrid(e).jqGrid("setGridParam", {"datatype": h})) : a(c).jqGrid(e)
                    ...
                    if (b && "string" == typeof b) {
                        ...
                        if (e && (a.jgrid.useJSON = !0), e = f[d.jsonGrid.config], f = f[d.jsonGrid.data]) {
                            var g = e.datatype;
                            e.datatype = "jsonstring", e.datastr = f, a(c).jqGrid(e).jqGrid("setGridParam", {"datatype": g})
                        } else a(c).jqGrid(e)
                    }
                };
                switch (b.imptype) {
            ...
            var b = a.extend({"exptype": "xmlstring", "root": "grid", "ident": "	"}, b || {}), c = null;
            return this.each(function () {
                if (this.grid) {
...
var xmlJsonClass = {
    "xml2json": function (a, b) {
        ...
        void 0 === d && (d = !0);
        var e = b ? '"' + b + '"' : "", f = "	", g = "\n";
        if (d || (g = f = ""), "[]" === a)e += b ? ":[]" : "[]"; else if (a instanceof Array) {
            var h, i, j = [];
    ...
    b.jgrid.extend({
        "sortableColumns": function (a) {
            return this.each(function () {
                ...
                var d = this, e = b.jgrid.jqID(d.p.id), e = {
                    "tolerance": "pointer",
                    "axis": "x",
                    "scrollSensitivity": "1",
                    ...
                    "update": function (a, c) {
                        var e = b(c.item).parent(), e = b(">th", e), f = {}, g = d.p.id + "_";
                ...
                if (d.p.sortable.options ? b.extend(e, d.p.sortable.options) : b.isFunction(d.p.sortable) && (d.p.sortable = {"update": d.p.sortable}), e.start) {
                    var f = e.start;
            ...
            if (!b("#colchooser_" + b.jgrid.jqID(d[0].p.id)).length) {
                var e = b('<div id="colchooser_' + d[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), f = b("select", e), a = b.extend({
                    "width": 420,
                    "height": 240,
                    "classname": null,
                    "done": function (a) {
                    ...
                    "apply_perm": function () {
                        ...
                        b("option:selected", f).each(function () {
                            ...
                            var a = parseInt(this, 10), b = c, d = a;
                            if (d >= 0) {
                                var e = b.slice(), f = e.splice(d, Math.max(b.length - d, d));
            ...
            return this.each(function () {
                ...
                var d, e, f = this;
                if (f.grid && !f.p.treeGrid && b.fn.draggable && b.fn.droppable)if (void 0 === b("#jqgrid_dnd")[0] && b("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"), "string" == typeof a && "updateDnD" === a && f.p.jqgdnd === !0)c(); else if (a = b.extend({
                        "drag": function (a) {
                            return b.extend({
                                "start": function (c, d) {
                                    var e;
                            ...
                            return b.extend({
                                "accept": function (a) {
                                    ...
                                    if (b(d.draggable).hasClass("jqgrow")) {
                                        var e = b(d.draggable).attr("id"), e = d.draggable.parent().parent().jqGrid("getRowData", e);
                                        if (!a.dropbyname) {
                                            var g, h, i = 0, j = {}, k = b("#" + b.jgrid.jqID(this.id)).jqGrid("getGridParam", "colModel");
                                            try {
                        ...
                        "autoid": !0,
                        "autoidprefix": "dnd_"
                    }, a || {}), a.connectWith)for (a.connectWith = a.connectWith.split(","), a.connectWith = b.map(a.connectWith, function (a) {
                    return b.trim(a)
            ...
            return this.each(function () {
                ...
                d.grid && b.fn.resizable && (a = b.extend({}, a || {}), a.alsoResize ? (a._alsoResize_ = a.alsoResize, delete a.alsoResize) : a._alsoResize_ = !1, a.stop && b.isFunction(a.stop) ? (a._stop_ = a.stop, delete a.stop) : a._stop_ = !1, a.stop = function (e, f) {
                    b(d).jqGrid("setGridParam", {"height": b("#gview_" + c + " .ui-jqgrid-bdiv").height()}), b(d).jqGrid("setGridWidth", f.size.width, a.shrinkToFit), a._stop_ && a._stop_.call(d, e, f)
